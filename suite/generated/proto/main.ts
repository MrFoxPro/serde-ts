...
export const UnitStruct: MessageFns<UnitStruct> = {
  encode(_: UnitStruct, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UnitStruct {
...
export const NewtypeStruct: MessageFns<NewtypeStruct> = {
  encode(message: NewtypeStruct, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NewtypeStruct {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TupleStruct: MessageFns<TupleStruct> = {
  encode(message: TupleStruct, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.first !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TupleStruct {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ComplexStruct: MessageFns<ComplexStruct> = {
  encode(message: ComplexStruct, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.inner !== undefined) {
      SimpleStruct.encode(message.inner, writer.uint32(10).fork()).join();
    }
    if (message.flag !== false) {
      writer.uint32(16).bool(message.flag);
    }
    for (const v of message.items) {
      MultiEnum.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.unit !== undefined) {
      UnitStruct.encode(message.unit, writer.uint32(34).fork()).join();
    }
    if (message.newtype !== 0) {
      writer.uint32(40).int32(message.newtype);
    }
    if (message.tuple !== undefined) {
      TupleStruct.encode(message.tuple, writer.uint32(50).fork()).join();
    }
    Object.entries(message.map).forEach(([key, value]) => {
      ComplexStruct_MapEntry.encode({ key: key as any, value }, writer.uint32(58).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ComplexStruct {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ComplexStruct_MapEntry: MessageFns<ComplexStruct_MapEntry> = {
  encode(message: ComplexStruct_MapEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ComplexStruct_MapEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MultiEnum: MessageFns<MultiEnum> = {
  encode(message: MultiEnum, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.variant?.$case) {
      case "variant_a":
        VariantA.encode(message.variant.variant_a, writer.uint32(10).fork()).join();
        break;
      case "variant_b":
        VariantB.encode(message.variant.variant_b, writer.uint32(18).fork()).join();
        break;
      case "variant_c":
        VariantC.encode(message.variant.variant_c, writer.uint32(26).fork()).join();
        break;
      case "unit_variant":
        UnitVariant.encode(message.variant.unit_variant, writer.uint32(34).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MultiEnum {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MultiEnum>, I>>(object: I): MultiEnum {
    const message = createBaseMultiEnum();
    switch (object.variant?.$case) {
      case "variant_a": {
        if (object.variant?.variant_a !== undefined && object.variant?.variant_a !== null) {
          message.variant = { $case: "variant_a", variant_a: VariantA.fromPartial(object.variant.variant_a) };
        }
        break;
      }
      case "variant_b": {
        if (object.variant?.variant_b !== undefined && object.variant?.variant_b !== null) {
          message.variant = { $case: "variant_b", variant_b: VariantB.fromPartial(object.variant.variant_b) };
        }
        break;
      }
      case "variant_c": {
        if (object.variant?.variant_c !== undefined && object.variant?.variant_c !== null) {
          message.variant = { $case: "variant_c", variant_c: VariantC.fromPartial(object.variant.variant_c) };
        }
        break;
      }
      case "unit_variant": {
        if (object.variant?.unit_variant !== undefined && object.variant?.unit_variant !== null) {
          message.variant = {
            $case: "unit_variant",
            unit_variant: UnitVariant.fromPartial(object.variant.unit_variant),
          };
        }
        break;
      }
...
export const VariantA: MessageFns<VariantA> = {
  encode(message: VariantA, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
      writer.uint32(8).int32(message.value);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VariantA {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VariantB: MessageFns<VariantB> = {
  encode(message: VariantB, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VariantB {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VariantC: MessageFns<VariantC> = {
  encode(message: VariantC, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.x !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VariantC {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UnitVariant: MessageFns<UnitVariant> = {
  encode(_: UnitVariant, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UnitVariant {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
